...
public class AssetSettingsWindow : EditorWindow {
	...
	Texture2D addTextureUp;
	Texture2D addTextureDown;
	Texture2D removeTextureUp;
	Texture2D removeTextureDown;
	Texture2D editTexture;
	Texture2D cancelTextureUp;
	Texture2D cancelTextureDown;
	Texture2D edgeBoxTexture;
